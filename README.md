...
自定义选择器、具体规则语法说明见 [规则说明](https://raw.githubusercontent.com/SadYuyuko/Search-Engine-Result-Hider/main/Other/Rule-Explanation.md)

调试模式、故障排除见 [测试说明](https://raw.githubusercontent.com/SadYuyuko/Search-Engine-Result-Hider/main/Other/Debug.md)
